...
add wave -noupdate -radix decimal -childformat {{/tb_top/address(23) -radix decimal} {/tb_top/address(22) -radix decimal} {/tb_top/address(21) -radix decimal} {/tb_top/address(20) -radix decimal} {/tb_top/address(19) -radix decimal} {/tb_top/address(18) -radix decimal} {/tb_top/address(17) -radix decimal} {/tb_top/address(16) -radix decimal} {/tb_top/address(15) -radix decimal} {/tb_top/address(14) -radix decimal} {/tb_top/address(13) -radix decimal} {/tb_top/address(12) -radix decimal} {/tb_top/address(11) -radix decimal} {/tb_top/address(10) -radix decimal} {/tb_top/address(9) -radix decimal} {/tb_top/address(8) -radix decimal} {/tb_top/address(7) -radix decimal} {/tb_top/address(6) -radix decimal} {/tb_top/address(5) -radix decimal} {/tb_top/address(4) -radix decimal} {/tb_top/address(3) -radix decimal} {/tb_top/address(2) -radix decimal} {/tb_top/address(1) -radix decimal} {/tb_top/address(0) -radix decimal}} -subitemconfig {/tb_top/address(23) {-height 15 -radix decimal} /tb_top/address(22) {-height 15 -radix decimal} /tb_top/address(21) {-height 15 -radix decimal} /tb_top/address(20) {-height 15 -radix decimal} /tb_top/address(19) {-height 15 -radix decimal} /tb_top/address(18) {-height 15 -radix decimal} /tb_top/address(17) {-height 15 -radix decimal} /tb_top/address(16) {-height 15 -radix decimal} /tb_top/address(15) {-height 15 -radix decimal} /tb_top/address(14) {-height 15 -radix decimal} /tb_top/address(13) {-height 15 -radix decimal} /tb_top/address(12) {-height 15 -radix decimal} /tb_top/address(11) {-height 15 -radix decimal} /tb_top/address(10) {-height 15 -radix decimal} /tb_top/address(9) {-height 15 -radix decimal} /tb_top/address(8) {-height 15 -radix decimal} /tb_top/address(7) {-height 15 -radix decimal} /tb_top/address(6) {-height 15 -radix decimal} /tb_top/address(5) {-height 15 -radix decimal} /tb_top/address(4) {-height 15 -radix decimal} /tb_top/address(3) {-height 15 -radix decimal} /tb_top/address(2) {-height 15 -radix decimal} /tb_top/address(1) {-height 15 -radix decimal} /tb_top/address(0) {-height 15 -radix decimal}} /tb_top/address
...
add wave -noupdate /tb_top/uut/i_dma/i_dma_state_machine/state
...
add wave -noupdate /tb_top/uut/i_dma/i_dma_state_machine/src
add wave -noupdate /tb_top/uut/i_dma/i_dma_state_machine/dst
add wave -noupdate /tb_top/uut/i_dma/i_dma_state_machine/base
add wave -noupdate /tb_top/uut/i_dma/i_dma_state_machine/src_adder/result
...
WaveRestoreCursors {{Cursor 1} {839309 ps} 0}
...
update
WaveRestoreZoom {675911 ps} {1108289 ps}
