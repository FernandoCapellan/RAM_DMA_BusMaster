...
add wave -noupdate -radix decimal /tb_dma_state_machine/base_address
add wave -noupdate -radix decimal /tb_dma_state_machine/source_address
add wave -noupdate -radix decimal /tb_dma_state_machine/destin_address
add wave -noupdate -radix decimal /tb_dma_state_machine/transfer_length
add wave -noupdate /tb_dma_state_machine/bus_rq
add wave -noupdate -radix decimal /tb_dma_state_machine/ram_addr
add wave -noupdate -radix decimal /tb_dma_state_machine/port_addr
...
WaveRestoreCursors {{Cursor 1} {41004 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1136312 ps}
